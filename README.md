...
[![Tests](https://github.com/octoper/puppeteer-cluster/actions/workflows/test.yml/badge.svg)](https://github.com/octoper/puppeteer-cluster/actions/workflows/test.yml)
[![npm](https://badgen.now.sh/npm/v/puppeteer-cluster)](https://www.npmjs.com/package/puppeteer-cluster)
[![Dependabot Status](https://api.dependabot.com/badges/status?host=github&repo=octoper/puppeteer-cluster)](https://dependabot.com)
